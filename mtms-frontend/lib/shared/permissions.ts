...
export const PERMISSION_LABELS: Record<PermissionKey, string> = {
  ...
  'module.create': 'Create sub-modules',
  'module.edit': 'Edit sub-module & sub-activities',
  ...
  'fni.signoff': 'Mark FNI done — close sub-module',
...
export const SEEDED_ROLES: {
  ...
  },
  {
    ...
    name: 'Release mgr',
    note: '',
    description: 'Runs the release: sub-modules, deliverables, prod confirmation and FNI sign-off.',
    permissions: [
      'project.view',
      'module.create',
      'module.edit',
